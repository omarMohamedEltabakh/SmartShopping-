...
const Sale = () => {
  ...
  // hooks===================================================>
  const { addToCart, numberOfCartItem, getCartItems, cartItemIds } = useContext(cartContext);
  ...
  const Sale = data?.data.data.filter((product) => product.price > 1500);
              ...
              <div className="pb-3 rounded-2 mt-4 cart  overflow-hidden shadow ">
                ...
                <div className="cartContent px-3">
                  ...
                  <div className="priceAndRate d-flex justify-content-between">
                    <span>
                    <s className="fw-medium" >{product.price} EGP</s>
                    <span className="fw-medium ms-2"  >{product.price-500} EGP</span>
                    </span>
